...
{
  if (maxContentSizeMultiplier != defaultMaxContentSizeMultiplier) {
    defaultMaxContentSizeMultiplier = maxContentSizeMultiplier;
    if (isnan(defaultMaxContentSizeMultiplier) || (defaultMaxContentSizeMultiplier != 0 && defaultMaxContentSizeMultiplier < 1)) {
      RCTLogError(@"maxContentSizeMultiplier value must be 0 or >= 1.");
      defaultMaxContentSizeMultiplier = 0.0;
    }
  }
}
